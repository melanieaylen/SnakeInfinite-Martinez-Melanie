...
public class EstadoJuego {
    ...
    public EstadoJuego(Serpiente serpiente, GestorFrutas gestorFrutas, 
                       int puntuacion, float posX, float posY, 
    ...
    public GestorFrutas getGestorFrutas() { return gestorFrutas; }
    public int getPuntuacion() { return puntuacion; }
    public float getPosElementosX() { return posElementosX; }
    public float getPosElementosY() { return posElementosY; }
    public Direcciones getDireccionActual() { return direccionActual; }
